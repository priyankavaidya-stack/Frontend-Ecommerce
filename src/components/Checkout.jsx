    ...
    return (
        <div className='border border-gray-300 rounded-lg'>
            ...
            <div className='items-center px-4 py-2 border-b border-b-gray-300 border-dashed'>
                <p className='py-2 flex justify-between'>Price ({cartItems.length===1 ? 'item' : 'items'}) <span className='font-semibold'>₹ {(totalPrice + 1000*cartItems.length).toLocaleString('en-IN')}</span></p>
